    ...
    <div class="container-fluid" style="width:100%;">
        <div class="row" style="background: rgb(185, 205, 248);">
            <div class="col-sm-3 side_bar pt-2 ">
                ...
                <a href="show_books.php" class="text" style="text-decoration: none;">Show Category</a><br><br>
            ...
            <h1 class="text-center p-5">ADD BOOKS</h1>
            <center> 
                   <div class="border rounded col-sm-4 p-3 background">
                   <form action="add_books_code.php"  method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="author" placeholder="Enter Authur Name  " class="form-control"><br>
                        <button class="btn form-control" >uploade</button>
                    </form>
                   </div>
                </center>
            </div>    
