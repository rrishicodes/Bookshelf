...
<body>
    ...
    <div class="container-fluid" style="width:100%;">
        <div class="row" style="background: rgb(185, 205, 248);">
            <div class="col-sm-3 side_bar pt-2 ">
                <img src="../img/elf-icon.png" alt="" height="50px">&nbsp;<span style="font-size: xx-large; font-family: cursive; ">Bookshelf</span><br>
                 <div class="style_n row mt-2">
                     <div class="col-sm-12 "><a href="dashboard.php" class="text_n"  style="text-decoration: none;">Dashboard</a></div>
                 </div>
                <br>
            ...
            <div class="col-sm-9">
                <table class="table table-bordered table_style table-responsive " >
                 <tr>
                     <th>ID</th>
                     <th>IMAGE</th>
                     <th>Name</th>
                 ...
                 {?>
                 <tr>
                     <td class="font-weight-bold"><?php echo $r['0']?></td>
                     <td class="font-weight-bold"><img src="../img/user_images/<?php echo $r['1']?>" height="100px" width="100px" alt=""></td>
                     <td class="font-weight-bold"><?php echo $r['2']?></td>
                     <td class="font-weight-bold"><?php echo $r['3']?></td>
                     <td class="font-weight-bold"><?php echo $r['4']?></td>
                     <td class="font-weight-bold"><?php echo $r['5']?></td>
                     <td class="font-weight-bold"><?php echo $r['6']?></td>
                     <td class="font-weight-bold"><?php echo $r['7']?></td>
                     <td class="font-weight-bold"><?php echo $r['8']?></td>
                     <td class="font-weight-bold"><?php echo $r['9']?></td>
                     <td><a href="delete_regustration_page.php?ids=<?php echo $r['0'];?>">Delete</a></td>
                 </tr>
                 <?php
                 }
                 ?>
