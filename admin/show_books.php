...
<body>
    ...
    <div class="container-fluid" style="width:100%;">
        <div class="row" style="background: rgb(185, 205, 248);">
            ...
            <div class="col-sm-9">
                <center>
                <table class="table table-bordered table_style  table-responsive  "  style="width:50%">
                 <tr>
                     <th>ID</th>
                     <th>IMAGE</th>
                     <th>Name</th>
                 ...
                 <tr>
                     <td ><?php echo $r['0']?></td>
                     <td ><img src="../img/book_img/<?php echo $r['1']?>" height="100px" width="100px" alt=""></td>
                     <td ><?php echo $r['2']?></td>
                     <td ><?php echo $r['3']?></td>
                     <td ><?php echo $r['4']?></td>
                     <td><a href="delete_books.php?ids=<?php echo $r['0'];?>">Delete</a></td>
                 </tr>
                 <?php
                 }
                 ?>
