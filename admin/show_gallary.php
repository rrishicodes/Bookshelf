...
<body>
   ...
   {
       ?>
                    <div class="col-sm-2 table card pt-3" >
                        <img src="../img/add_gallary/<?php echo $r['1']?>" height="100%" width="100%">
                        <a href="delete_images.php?ids=<?php echo $r['0'];?> " style="text-align:center">Delete</a>     
                    </div>&nbsp;&nbsp;
                    <?php
                    }?>         
                    </div>  
