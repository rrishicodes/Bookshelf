    ...
    <div class="container-fluid">
        ...
        <?php while($r=mysqli_fetch_array($res,MYSQLI_BOTH))
            ...
            <a href="books_page.php" class="text-dark" style="text-decoration:none;">
                <img src="./img/add_gallary/<?php echo $r['1']?>" alt="" style="border-radius:50%; height:55%; width:80%; vertical-align:center"><br><br>
                <h2 class=" font-italic" style="font-size: small;"><?php echo $r['2']?></h2>
              </a>
...
<div class="modal" id="login" >
  <div class="modal-dialog" >
      <div class="modal-content">
          ...
          <div class="modal-body badge-light">
            <form action="userlogincode.php" method="post"  class=" font-weight-bold">
