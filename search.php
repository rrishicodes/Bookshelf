...
$search=$_POST['search'];
$sel="select * from books where name like '%$search%'";
  ...
  <nav class="navbar navbar-expand-lg  bg-light" style="position:sticky;top:0px;z-index:999; width:100%;" >
    ...
    <div class="container-fluid">
        ...
        <?php while($r=mysqli_fetch_array($res,MYSQLI_BOTH))
                 {?>
            <div class="col-sm-2 pt-2 card mb-2">
              <a href="bookpage.php?id=<?php echo $r['0']; ?>" class="text-dark hover" style="text-decoration:none;">
              <img height="250px" width="100%"  src="./img/book_img/<?php echo $r['1']?>" alt="">
              <div class="card-body text-left">
                      <h2 class=" text-left font-italic" style="font-size: small;"><?php echo $r['2']?></h2>
                      <p style="font-size: smaller;">by <span class="text-uppercase font-weight-bold"><?php echo $r['4']?></span></p>
                      <span class="text-uppercase text-danger" style="font-size: smaller;"><?php echo $r['3']?> Rs</span>
              </div>
              </a>
            </div>
            <?php
            ...
            <form action="registration_code.php" method="post">
                      <div class=" font-weight-bold">
                              ...
                              <div class="form-group text-center">
                                Do you have an account? <a href=""  data-target="#login" data-toggle="modal"  data-dismiss="modal">Sign in</a> 
                            </div>
                      </div>
                  </div>
              </div>
...
<div class="modal" id="login" >
  <div class="modal-dialog" >
      <div class="modal-content">
          ...
          <div class="modal-body badge-light">
            <form action="logincode.php" method="post"  class=" font-weight-bold">
